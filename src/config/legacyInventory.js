export const legacySystems = [
  ...
  },
  {
    id: 'firebase-adv',
    name: 'firebase_adv',
    stack: 'React + Firebase Auth + Firestore + Vite + Capacitor',
    ...
    strengths: [
      ...
      'Capacitor and PWA setup reduce effort for Android APK packaging.',
    ],
    risks: [
...
export const architectureDecisions = [
  ...
  {
    title: 'Use Capacitor after web flows stabilize',
    detail:
