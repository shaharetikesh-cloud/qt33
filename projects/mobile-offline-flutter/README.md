...
This folder is the independent **offline Flutter mobile project** copy.

- Project root id: `mobile-offline-flutter`
- This project is separate from web-connected React/Capacitor code.
- Open this folder directly in Android Studio/VS Code for Flutter work.
...
- Keep Flutter configs local to this folder (`android/`, `pubspec.yaml`, assets).
- Do not reuse web `.env` files in this project.
