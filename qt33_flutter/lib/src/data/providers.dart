...
import 'package:qt33/src/features/reports/monthly_report_automation_service.dart';
...
final monthlyReportAutomationServiceProvider = Provider(
  (ref) => MonthlyReportAutomationService(
    moduleRepo: ref.read(moduleRecordRepositoryProvider),
